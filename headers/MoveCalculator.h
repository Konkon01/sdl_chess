...
class MoveCalculator {
  ...
  void left_to_right(int f_ind, char f_piece, std::vector<int> &p_moves);
  void upper_left_to_lower_right(int f_ind, char f_piece, std::vector<int> &p_moves);
  void up_to_down(int f_ind, char f_piece, std::vector<int> &p_moves);
  void lower_left_to_upper_right(int f_ind, char f_piece, std::vector<int> &p_moves);
